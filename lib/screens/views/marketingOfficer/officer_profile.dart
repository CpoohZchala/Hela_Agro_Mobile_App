...
class _OfficerProfileScreenState extends State<OfficerProfileScreen> {
  ...
  final String apiUrl = "https://dearoagro-backend.onrender.com/api/officers";

  @override
  void initState() {
    super.initState();
    print("OfficerProfileScreen userId: ${widget.userId}");
    fetchUserProfile();
  }

  Future<void> fetchUserProfile() async {
    try {
      print("Fetching user profile for userId: ${widget.userId}");
      ...
      print("Decoded API response: $user");
                      ...
                      _buildProfileOption(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => OfficerUpdateProfileScreen(
                      ...
                      _buildProfileOption(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => OfficerChangePasswordScreen(
                                userId: widget.userId,
